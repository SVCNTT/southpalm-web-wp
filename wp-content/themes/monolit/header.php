...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class( );?>>
    <?php $fullwidth_nav_menu = get_post_meta( get_queried_object_id(), "_monolit_fullwidth_nav_menu", true); 
        if(!empty($fullwidth_nav_menu)&&$fullwidth_nav_menu == 'yes'){
    ?>
                    ...
                    <?php endif; ?>>
                        <a href="<?php echo esc_url(home_url('/'));?>">
                            ...
                            <?php if( monolit_global_var('logo_text') ):?>
                                <h1 class="logo_text"><?php echo esc_html( monolit_global_var('logo_text') );?></h1>
                            <?php endif;?>
