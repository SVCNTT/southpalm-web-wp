 	...
 	function cth_select_media_file_field($f_id = 'cat_header_image',$f_title = 'Header Background Image', $term_values = array(),$new_screen = true){
 		if($new_screen){
 			...
 			echo '<tr class="form-field">';
	            ...
	            echo '<p class="description"><a href="#" class="button button-primary upload_image_button metakey-term_meta fieldkey-'.$f_id.'">'.esc_html__('Upload Image', 'monolit').'</a>  <a href="#" class="button button-secondary remove_image_button_btn metakey-term_meta fieldkey-'.$f_id.'">'.esc_html__('Remove', 'monolit').'</a></p>';
	    if($new_screen){
 			echo '</div>';
