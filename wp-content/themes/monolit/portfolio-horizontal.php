...
if( $show_page_header == 'yes'|| get_post_meta(get_the_ID(),'_monolit_folio_content_footer',true ) == 'yes' ) $is_hoz_header_footer = true;
...
<!-- content  -->
<div class="content hor-content full-height pad-con no-bg-con portfolio-horizontal">
...
if($portfolio->have_posts()) : 
    ...
    $grid_cls .= ' '.get_post_meta(get_the_ID(),'_monolit_folio_columns', true ).'-ver-columns';
    ...
    $grid_cls .= ' grid-'.get_post_meta(get_the_ID(),'_monolit_folio_pad', true ).'-pad';
        ...
        <div class="p_horizontal_wrap<?php if($is_hoz_header_footer) echo ' hoz_has_headfoot_wrap';?>">
            <div id="portfolio_horizontal_container" class="<?php echo esc_attr($grid_cls );?>">
                <?php while($portfolio->have_posts()) : $portfolio->the_post(); ?>
                    ...
                    <?php monolit_get_template_part( 'portfolio',  'horizontal-list', array( 'columns'=> get_post_meta(get_the_ID(),'_monolit_folio_columns', true ) ) ); ?>
