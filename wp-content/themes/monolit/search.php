                ...
                <div class="page-title">
                    ...
                    ?>
                        <div class="<?php echo esc_attr($hcl );?>">
                            <h2><?php printf(esc_html__('Search Results for "%s" Query','monolit'),get_search_query( ));?></h2>
        ...
        <section id="blog_sec1">
            <div class="container">
                ...
                <?php endif;?>
                    ...
                    <?php if( !monolit_global_var('show_blog_header') ) :?>
                        <h2 class="page-title search-page-title"><?php printf(esc_html__('Search Results for "%s" Query','monolit'),get_search_query( ));?></h2>
                    <?php endif;?>
