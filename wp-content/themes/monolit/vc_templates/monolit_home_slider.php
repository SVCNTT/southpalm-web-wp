        ...
        <div class="hero-wrap-image-slider-holder">
            <div class="home-slider-loop owl-carousel owl-theme refrestonresizeowl keyboardcontr" data-options='<?php echo json_encode($dataArr);?>'>
                ...
                <div class="item">
                    ...
                    <div class="bg" data-bg="<?php echo esc_url(monolit_get_attachment_thumb_link($bgimg, 'monolitfuls-thumb') );?>" data-top-bottom="transform: translateY(<?php echo esc_attr($parallax_value);?>px);" data-bottom-top="transform: translateY(<?php echo 0 - $parallax_value;?>px);"></div>
