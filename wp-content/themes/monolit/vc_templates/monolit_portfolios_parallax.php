...
<div class="<?php echo esc_attr(  $css_class );?>">
    ...
    <?php if(!empty($view_all_link)):?>
        ...
        <div class="custom-link-holder">
            <a href="<?php echo esc_url($view_all_link );?>" class="btn anim-button"  data-top-bottom="transform: translateY(-50px);" data-bottom-top="transform: translateY(50px);"><?php echo wp_kses(__('<span>View All Projects</span><i class="fa fa-long-arrow-right"></i>','monolit'), array('span'=>array('class'=>array()),'i'=>array('class'=>array())) );?></a>   
        </div>
