...
<?php if($parallax_inner!='') :?>
    ...
    <div class="parallax-inner">
        <div class="bg" data-bg="<?php echo esc_url(monolit_get_attachment_thumb_link($parallax_inner, 'monolitfuls-thumb') );?>" data-top-bottom="transform: translateY(<?php echo esc_attr($parallax_inner_val);?>px);" data-bottom-top="transform: translateY(<?php echo 0-$parallax_inner_val;?>px);"></div>
...
<div <?php
    ...
    <?php if($head_video_id!='') :?>
        <div class="media-container header-video" data-top-bottom="transform: translateY(<?php echo esc_attr($parallax_inner_val);?>px);" data-bottom-top="transform: translateY(<?php echo 0-$parallax_inner_val;?>px);">
            ...
            <div class="mob-bg bg" data-bg="<?php echo esc_url(monolit_get_attachment_thumb_link($parallax_inner, 'monolitfuls-thumb') );?>"></div>
...
<div <?php
    ...
    <div class="control-panel<?php if($show_cap == 'no' && $show_thumbs == 'no' && $show_more_info == 'no') echo ' hide-cpanel';?>">
        <div class="container">
            ...
            <?php if($show_more_info == 'yes'):?><a href="#" class=" btn anim-button   flat-btn   transition    show-hid-sidebar"><?php echo wp_kses(__('<span>More information</span><i class="fa fa-eye"></i>','monolit'), array('span'=>array(),'i'=>array('class'=>array()),) );?></a><?php endif;?>
            <?php if($show_thumbs == 'yes') :?>
            <span class="show-thumbs vis-con-panel vis-t" data-textshow="<?php esc_html_e('Show thumbnails','monolit');?>" data-texthide="<?php esc_html_e('Hide thumbnails','monolit');?>"></span>
            <?php endif;?>
        </div>
    </div>
<?php
...
<div <?php
    ...
    <div class="fix-con-panel<?php if($show_thumbs == 'no' && $show_more_info == 'no') echo ' hide-cpanel';?>">
        <?php if($show_thumbs == 'yes') :?><span class="show-thumbs hid-con-panel vis-t" data-textshow="<?php esc_html_e('Show thumbnails','monolit');?>" data-texthide="<?php esc_html_e('Hide thumbnails','monolit');?>"></span><?php endif;?>
        <?php if($show_more_info == 'yes') :?><a href="#" class="  show-hid-sidebar"><?php esc_html_e(' info','monolit');?></a><?php endif;?>
    </div>
<?php
if(!empty($gallery_images)){
    $gal_imgs = explode(",", $gallery_images);
    ...
    <div class="resize-carousel-holder lightgallery fhgal ogm smp hid-gal">
        ...
        ?>
            ...
            <?php if(!empty($at_des)|| !empty($at_alt)):?>
                <div class="show-info">
                    <span><?php esc_html_e('Info','monolit');?></span>
...
<div <?php
    ...
    <div class="fix-con-panel<?php if($show_more_info == 'no') echo ' hide-cpanel';?>">
        <a href="#" class="show-hid-sidebar vd"> <?php esc_html_e('More info','monolit' );?></a>
    </div>
...
if(!empty($gallery_images)){
    ...
    ?>
        ...
        ?>
            ...
            ?>
                <div class="bg"  data-bg="<?php echo esc_url(monolit_get_attachment_thumb_link($img, 'monolitfuls-thumb') );?>"></div>
            <?php } ?>
    ...
    <div <?php
        ...
        <div class="media-container">
            ...
            <div class="bg mob-bg" <?php if(!empty($video_bg_id)) : ?>
             data-bg="<?php echo esc_url(monolit_get_attachment_thumb_link($video_bg_id, 'monolitfuls-thumb') );?>"
            <?php endif;?>></div>
